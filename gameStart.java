		...
		SwingUtilities.invokeLater(new Runnable() {//standard swing implementation of jframe/jpanel
			...
			public void run() {
				...
				try{																							//try catch block that finds all images and sends them to panel
					control.panel.setMapImage(ImageIO.read(getClass().getResource("/resources/map.png")));			//this is done to reduce lag caused by constant image searching
					
					control.panel.setTower1Image(ImageIO.read(getClass().getResource("/resources/tower 1.png")));	//game was struggling to run while continuosly searching
					control.panel.setTower2Image(ImageIO.read(getClass().getResource("/resources/tower 2.png")));	//files for images
					control.panel.setTower3Image(ImageIO.read(getClass().getResource("/resources/tower 3.png")));	//these can be found in the panel class
					control.panel.setTower4Image(ImageIO.read(getClass().getResource("/resources/tower 4.png")));
					control.panel.setTower5Image(ImageIO.read(getClass().getResource("/resources/tower 5.png")));
					
					control.panel.setWeakImage(ImageIO.read(getClass().getResource("/resources/weak enemy.png")));
					control.panel.setAverageImage(ImageIO.read(getClass().getResource("/resources/average enemy.png")));
					control.panel.setStrongImage(ImageIO.read(getClass().getResource("/resources/strong enemy.png")));
					control.panel.setBossImage(ImageIO.read(getClass().getResource("/resources/boss enemy.png")));
					
					control.panel.setInfoImage(ImageIO.read(getClass().getResource("/resources/info button.png")));
					control.panel.setWaitImage(ImageIO.read(getClass().getResource("/resources/wait button.png")));
					control.panel.setCancelImage(ImageIO.read(getClass().getResource("/resources/cancel button.png")));
					control.panel.setStartImage(ImageIO.read(getClass().getResource("/resources/start button.png")));
					
					control.panel.setSpeedUpImage(ImageIO.read(getClass().getResource("/resources/speed up button.png")));
					control.panel.setSlowDownImage(ImageIO.read(getClass().getResource("/resources/slow down button.png")));
					
					control.panel.setDeleteImage(ImageIO.read(getClass().getResource("/resources/delete button.png")));
					control.panel.setLaser1(ImageIO.read(getClass().getResource("/resources/yellowLaser.png")));
					control.panel.setLaser2(ImageIO.read(getClass().getResource("/resources/orangeLaser.png")));
					control.panel.setLaser3(ImageIO.read(getClass().getResource("/resources/pinkLaser.png")));
					control.panel.setLaser4(ImageIO.read(getClass().getResource("/resources/blueLaser.png")));
					control.panel.setLaser5(ImageIO.read(getClass().getResource("/resources/greenLaser.png")));
					
					control.panel.setRestartImage(ImageIO.read(getClass().getResource("/resources/Restart.png")));
					control.panel.setGameOverBanner(ImageIO.read(getClass().getResource("/resources/GOBanner.png")));
					control.panel.setExitButton(ImageIO.read(getClass().getResource("/resources/exitButton.png")));
					
					control.panel.setLaserSound(getClass().getResource("/resources/laser.wav").toString());
